...
# detect_leaks
clang -Wall -Wextra -Wtautological-compare -Wsign-compare -O1 -flto=full -gfull -fstandalone-debug  -ftrivial-auto-var-init=pattern -pipe -fintegrated-as -fintegrated-cc1 -ffunction-sections -fdata-sections -Wl,-dead_strip -Wl,-pie -fstack-protector-all -fno-sanitize-recover=all -fvisibility=hidden -fsanitize=undefined -fsanitize=integer -fsanitize=address -fsanitize-address-use-after-scope -fsanitize-address-use-odr-indicator -fno-omit-frame-pointer -fno-optimize-sibling-calls -fno-common -U_FORTIFY_SOURCE -fPIE  "$@" -lm
